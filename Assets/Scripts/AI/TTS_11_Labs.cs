...
public class TTS_11_Labs : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        if (debug) Debug.Log("TTS 11Labs:You have selected voice " + sfVoice + " with index " + selectedVoiceIndex + " and model " + sfModel + " and output format "+sfOutput);
    ...
    IEnumerator PlayTTS(string mesg)
    {
        ...
        else Debug.LogError("11Labs TTS API Request failed: " + request.error);
    }
