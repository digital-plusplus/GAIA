...
public class TTI_HF_SDXLB : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        //Now get the AI Orchestrator link
    ...
    IEnumerator SD(string prompt)
    {
        ...
        {
            //First we have to TURN OFF THE CAMERA if available so we can use the ImageFrame to send our image to
            aiO.CameraOff();
